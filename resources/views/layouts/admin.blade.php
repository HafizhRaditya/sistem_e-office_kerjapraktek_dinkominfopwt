...
@php
    ...
    $navItems = [
        ...
        ['label' => 'Manajemen Kategori', 'icon' => 'category', 'url' => \Illuminate\Support\Facades\Route::has('admin.categories.index') ? route('admin.categories.index') : null, 'active' => request()->routeIs('admin.categories.*'), 'enabled' => \Illuminate\Support\Facades\Route::has('admin.categories.index')],
        ...
        ['label' => 'Manajemen Kuisioner', 'icon' => 'quiz', 'url' => \Illuminate\Support\Facades\Route::has('admin.questionnaires.index') ? route('admin.questionnaires.index') : null, 'active' => request()->routeIs('admin.questionnaires.index', 'admin.questionnaires.create', 'admin.questionnaires.store', 'admin.questionnaires.edit', 'admin.questionnaires.update', 'admin.questionnaires.destroy'), 'enabled' => \Illuminate\Support\Facades\Route::has('admin.questionnaires.index')],
        ['label' => 'Statistik Kuisioner', 'icon' => 'poll', 'url' => \Illuminate\Support\Facades\Route::has('admin.questionnaires.statistics') ? route('admin.questionnaires.statistics') : null, 'active' => request()->routeIs('admin.questionnaires.statistics'), 'enabled' => \Illuminate\Support\Facades\Route::has('admin.questionnaires.statistics')],
